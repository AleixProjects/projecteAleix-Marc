...
export default defineConfig({
	...
	build: {
      ...
      input: {
        ...
        changePasswordConfirm: path.resolve(__dirname, 'app/changePasswordConfirm.html'),
        ...
        registerFinalStepsMail: path.resolve(__dirname, 'app/register-finalsteps-mail.html'),
        registerFinalSteps: path.resolve(__dirname, 'app/register-finalsteps.html'),
